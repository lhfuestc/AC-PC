...
DEFAULT_TRAIN_ACPC_DIR = 'data/trainACPCdata150'
DEFAULT_TRAIN_LABEL_DIR = 'data/trainACPC150Label.txt'
DEFAULT_VALID_ACPC_DIR = 'data/testACPCdata150'
DEFAULT_VALID_LABEL_DIR = 'data/testACPC150Label.txt'
DEFAULT_LABEL_SAVE_DIR = 'data/result/ResultOfTest.csv'
valid_dir = '../'
...
parser.add_argument('--save_ACPCpoint', type = bool, default = False,
